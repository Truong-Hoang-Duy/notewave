import { CalendarClock, CheckSquare, Gavel, ListChecks, RotateCw, Sparkles, TriangleAlert, User } from 'lucide-react'
...
export default function SummaryPanel({ summary, outdated, loading, error, disabled, onSummarize }) {
  if (loading) {
    return (
